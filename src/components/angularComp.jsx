...
class AngularComp extends Component{
    ...
    handleOptionChange = (options) => {
        this.callURL("/job/Angular", options);
    }
    ...
    render(){
        const { pageNum, currentIndex } = this.state;
        ...
        let resumes1 = resumes.filter((r) => r.tech === "Angular");
